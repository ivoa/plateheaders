...
(plate2011, later pyplates) and a specific digitisation project
...
This specification does not use the FITS convention on long
keywords\todo{ref?}.  However, FITS continuation lines are explicitly
...
TELAPER   &float   &Clear aperture of the telescope [m]\\
TELFOC    &float   &Focal length of the telescope [m]\\
TELSCALE  &float   &Plate scale of the telescope [arcsec/mm]\\
...
Greenwhich sidereal time, \verb|ST| should be used, for universal time or
...
FOV1     &float  &Field of view along axis 1 [deg]\\
FOV2     &float  &Field of view along axis 2 [deg]\\
...
contents of these fields.\todo{Aren't FOV1 and FOV2 properties of the
observation and should hence be in group2?}
